...
@mcp.tool()
async def text_to_image(prompt: str, seed: int, steps: int, cfg: float, denoise: float, width: int = 1024, height: int = 1024) -> list[Image]:
...
@mcp.tool()
async def run_workflow_from_json(json_data: dict) -> list[Image]:
